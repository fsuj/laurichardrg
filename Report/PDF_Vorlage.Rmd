...
BUnwarpJ results in an overall mean annual displacement of 0.68m (sigma of 0.37m/a) and a median annual displacement of 0.64m (interquartile range IQR of 0.58m/a). IMCORR results in higher mean annual displacement rates of 0.79m (sigma of 0.51m/a) and a higher median of 0.87m/a (IQR of 0.9m/a). We find the results to differ accordingly in maximum annual displacements of 1.72m and 2.38m, respectively (table \ref{tab:compare_stats}).
...
```{r compare_scatter, echo=FALSE, fig.pos="h",fig.align="center", out.width = "300px", fig.cap= "Scatterplots of algorithm results at validation data points vs. validation data. Upper: BUnwarpJ; Lower: IMCORR algorithm. Left: GPS measured boulders; Right: Manually mapped"}
