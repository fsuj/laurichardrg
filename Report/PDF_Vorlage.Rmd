...
```{r area, echo=FALSE, fig.pos="h",fig.align="center", out.width = "300px", fig.cap= "Overview of the study site: The Laurichard rock glacier. Input data for algorithms and validation data sets are indicated as points."}
...
```{r compare_scatter, echo=FALSE, fig.pos="h",fig.align="center", out.width = "300px", fig.cap= "Scatterplots "}
