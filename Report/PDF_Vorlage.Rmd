...
Test III: The test of weighting combinations clearly shows that weights for local image characteristics ()
...
```{r echo=FALSE, fig.pos="h",fig.align="center", out.width = "500px", fig.cap= "Comparison of BUnwarpJ und IMCORR, final Results"}
...
```{r echo=FALSE, fig.pos="h",fig.align="center", out.width = "300px", fig.cap= "Comparison of BUnwarpJ und IMCORR, final Results"}
