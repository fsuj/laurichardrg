...
3. input images (DEMs and derivates).
...
\vspace{-0.5cm}
We masked the resulting (data)interpolated) deformation velocity fields as well the two validation data sets, excluding stable areas, a steep rock wall and obviously striped data in the 2012 DEM from the validation procedure. We compared our resulting deformation fields to the validation 

We analyzed the influence of extreme deformation/velocity values on BUnwarpJ by comparing two landmark sets with the validation data sets. We used the better performing landmark 
